 ...
 */
#ifndef DNP3_APPLICATION_HELPER_H
#define DNP3_APPLICATION_HELPER_H
 ...
 * on a set of nodes.
 */
class Dnp3ApplicationHelper
{
public:
  /**
   * Create a Dnp3MIMApplicationHelper to make it easier to work with Dnp3MiMApplications
   *
   ...
   * \param address1 the address of the first victim,
   * \param address2 the address of the second victim,
   *
   */
  Dnp3ApplicationHelper (std::string protocol, Address address1, Address address2);
  ...
  Ptr<Dnp3Application> Install (Ptr<Node> node, const std::string &name);
...
private:
   ...
   */
  Ptr<Dnp3Application> InstallPriv (Ptr<Node> node) const;

  Ptr<Dnp3Application> InstallPriv (Ptr<Node> node, const std::string &name);
...
#endif /* DNP3_APPLICATION_HELPER_H */
